...
const recommendedArticles = [{
  ...
  minsLength: 7,
  imagePath: 'https://demos.telerik.com/blazor-ui-dev/images/grid-layout/machine-learning.jpg',
  ...
  minsLength: 6,
  imagePath: 'https://demos.telerik.com/blazor-ui-dev/images/grid-layout/climate.jpg',
  date: new Date()
}, {
  author: 'Ali Tamaseb',
  ...
  minsLength: 8,
  imagePath: 'https://demos.telerik.com/blazor-ui-dev/images/grid-layout/books.jpg',
  ...
  return <div className="grid-layout-container">
      ...
      width: 310
        ...
        <GridLayoutItem row={5} col={3}>
          <Calendar className="event-calendar" value={selectedDate} onChange={handleChange} bottomView="year" topView="decade" navigation={false} />
          <div className="k-text-inverse k-text-uppercase k-font-weight-bold k-mt-4"> Discover more </div>
          <ChipList className={'k-flex-wrap'} selection="multiple" defaultData={tags} textField="name" valueField="name" chip={props => <Chip {...props} fillMode={'outline'} />} />
        </GridLayoutItem>
      </GridLayout>
    </div>;
};
